// src/components/Forms/BraceletForm.js
...
const BraceletForm = ({ details, setDetails }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Bracelet Size */}
      <div>
        <label className="block text-gray-700 font-medium mb-2">Bracelet Size (inches)</label>
        <input
          type="text"
          value={details.braceletSize || ''}
          onChange={(e) => handleChange('braceletSize', e.target.value)}
          className="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
