...
const NecklaceForm = ({ details, setDetails }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Necklace Size */}
      <div>
        <label className="block text-gray-700 font-medium mb-2">Necklace Size (inches)</label>
        <input
          type="text"
          value={details.necklaceSize || ''}
          onChange={(e) => handleChange('necklaceSize', e.target.value)}
          className="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
